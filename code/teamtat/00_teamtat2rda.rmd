...
data_input_path="V:/FACULTY/DJLEMAS/NLP_Data/infantfeeding/annotations/project4.2/v1/xml/"
...
teamtat_project="project_4.2"
teamtat_version="v1"
now <- Sys.time()
analysis_date=paste0(format(now, "%Y%m%d"))

data_output_path="V:/FACULTY/DJLEMAS/NLP_Data/infantfeeding/annotations/project4.2/v1/rda/"
