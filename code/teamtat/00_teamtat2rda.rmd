...
data_input_path="V:/FACULTY/DJLEMAS/NLP_Data/infantfeeding/annotations/project8/v3/xml/"
...
teamtat_project="project_8"
teamtat_version="v3"
now <- Sys.time()
analysis_date=paste0(format(now, "%Y%m%d"))

data_output_path="V:/FACULTY/DJLEMAS/NLP_Data/infantfeeding/annotations/project8/v3/rda/"
